...
public class Main {
    public static void main(String[] args) {
        ...
        mass[1] = new Person("Roman", 18, "M", new Address("Vitebsk","Belarus"));
        mass[2] = new Person("Andrei", 32, "M", new Address("Minsk","Belarus"));
        mass[3] = new Person("Aleksandr", 23, "M", new Address("Gomel","Belarus"));
        ...
        mass[12] = new Person("Aleksandr", 25, "M", new Address("Minsk","Belarus"));
